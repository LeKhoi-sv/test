...
public class Main {
    ...
    static void xoaCD(CDList ql) {
        try {
            ...
            if (ql.xoaCD(ma))
                System.out.println("🗑 Đã xóa CD mã " + ma);
    ...
    static void timTheoTienTo(CDList ql) {
        ...
        System.out.println("🔎 Tìm thấy " + kq.laySoLuong()
    ...
    static void thongKe(CDList ql) {
        ...
        System.out.printf("💰 Tổng giá thành: %.2f VNĐ%n",
                ql.tinhTongGiaThanh());

        System.out.printf("📈 Giá trung bình: %.2f VNĐ%n",
                ql.tinhGiaTrungBinh());

        CD max = ql.timCDDaiNhat();
